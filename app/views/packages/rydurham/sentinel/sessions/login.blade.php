...
<div class="row">
    <div class="col-md-4 col-md-offset-4">
        {{ Form::open(array('action' => 'Sentinel\SessionController@store','class'=>'well well-lg')) }}
            ...
            <a class="btn btn-info" href="{{ route('Sentinel\forgotPasswordForm') }}">Forgot Password</a>
        {{ Form::close() }}
    </div>
</div>
