...
<div class="col-md-8">
    ...
    <div class="col-md-6">
        <div class="small-box bg-aqua">
            <div class="inner">
                ...
                <p>{{ Form::select('class_detail_id', $classes , null , ['class' => 'form-control chosen-select'])
                    }}</p>
            </div>
    ...
    <div class="row" style="margin-top: 30px">
        <div class="col-md-10 col-md-offset-1">
            <img src="{{ asset('img/student_welcome.jpg') }}" class="img img-responsive">
        </div>
    </div>
</div>
{{ Form::close() }}
<div class="col-md-4">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-footer">
                    ...
                    <div class="text-right">
                        Posted By : {{ ucfirst($notice->teachers->first_name) }} {{
                        ucfirst($notice->teachers->last_name) }}
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="panel-footer text-center"><a href="{{ route('view.notices') }}" class="btn btn-block btn-primary">View
                All</a></div>
    </div>
</div>
@stop